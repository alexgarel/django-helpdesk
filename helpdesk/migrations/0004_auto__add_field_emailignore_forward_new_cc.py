...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'IgnoreEmail.forward_new_cc'
        db.add_column(
            'helpdesk_ignoreemail', 'forward_new_cc',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'IgnoreEmail.forward_new_cc'
        db.delete_column('helpdesk_ignoreemail', 'forward_new_cc')
    ...
    models = {
        ...
        'helpdesk.ignoreemail': {
            ...
            'forward_new_cc': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'queues': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['helpdesk.Queue']", 'symmetrical': 'False', 'null': 'True', 'blank': 'True'})
        },
        'helpdesk.kbcategory': {
